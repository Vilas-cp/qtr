  ...
  return (
    <div className="fixed top-0 left-0 h-full w-[100px] bg-gray-50 text-black shadow-lg border-r-[0.5px] border-gray-300 flex flex-col justify-between z-40">
      <nav className="mt-4 flex flex-col space-y-8 px-4">
        ...
        <a href="/flow" className="px-4 py-2 rounded">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <a href="/clock1" className="px-4 py-2 rounded">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <a href="/group" className="px-4 py-2 rounded">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
      ...
      <div className="mb-4 px-4 flex items-center justify-center">
        <SignedOut>
          <SignInButton>
            <button className="w-full px-2 py-2 text-sm text-white bg-black rounded">
              Sign In
            </button>
          </SignInButton>
        </SignedOut>
